...
window.MHRS_RECORDS = [
  ...
  /* ---- 以下为演示/示例数据，正式使用前请删除或替换 ---- */
  {
    ...
    platform: 'pc', note: '这是演示数据，请删除或替换。'
  },
  {
  ...
  },
  {
    ...
    platform: 'pc', note: '多视频链接示例（B站+YouTube 镜像）。'
  },
  {
  ...
  },
  {
    ...
    platform: 'pc', note: '霸主档（mod 探究任务）演示'
  },
  {
