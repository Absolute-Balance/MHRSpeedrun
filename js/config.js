...
window.MHRS_CONFIG = {
   ...
   * EX1~EX9 常规星级（Apex/霸主 分类已按站规移除）
   * ---------------------------------------------- */
  exStars: ['EX1', 'EX2', 'EX3', 'EX4', 'EX5', 'EX6', 'EX7', 'EX8', 'EX9'],

  /* ---- 狩猎规则（单选；默认“全部”）----
   * 已按站规移除「无限制规则」赛道，仅收录 三无规则 / TA规则 */
  rules: [
  ...
  /* ---- 投稿/审核后端（Cloudflare Worker，已部署）---- */
  submit: {
    apiBase: 'https://mhrs-api.absolutebalance7.workers.dev',
