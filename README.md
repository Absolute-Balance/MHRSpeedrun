...
面向怪物猎人崛起曙光（MHRS）竞速社群的开源成绩收录站：

- 以「怪物 ×  武器」矩阵展示各位置**当前最快成绩**
- 支持 烈祸袭来 / 怪异探究Lv300 / 特别探究 三种赛道
- 点击成绩可看视频、作者、历史记录；点击作者可看个人成绩时间线
- **访客可投稿**，管理员审核通过后发布，正式数据与草稿完全隔离

## 功能

- 浏览：烈祸袭来 / 怪异探究任务 → 对应怪物 × 14 武器，单格只显示最快成绩
...
- 狩猎规则：三无规则、TA 规则
- 时间格式：`分'秒''毫秒`（如 `05'02''52`）；结算时未展示毫秒的默认按 `99` 计
...
1. 打开站点 → 点击 **✉ 投稿成绩**
2. 依次选择：任务类型 → 烈祸任务 / 怪异探究任务 → EX 星级 → 怪物
